...
class DatasetController {
  ...
  _getSharedOptions(t, e) {
    ...
    return (
      this.updateSharedOptions(a, e, i), { sharedOptions: a, includeOptions: n }
    );
  }
...
function titleAlign(t, e, i) {
  ...
  return (
    ((i && "right" !== e) || (!i && "right" === e)) && (s = reverseAlign(s)), s
  );
}
    ...
    if ("mousemove" === t.type || "mouseout" === t.type) {
      const n = this._hoveredItem,
        o =
          ...
          null !== (s = n) &&
            null !== a &&
            s.datasetIndex === a.datasetIndex &&
            s.index === a.index);
      n && !o && callback(e.onLeave, [t, n, this], this),
        (this._hoveredItem = i),
        i && !o && callback(e.onHover, [t, i, this], this);
...
//# sourceMappingURL=/sm/7541c6f8284e2cfebf50db0869a3cee6a9f5d712744c65f0964d8bc39aa2facf.map
